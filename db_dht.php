...
<head>
  ...
  <meta name="description" content="ICA DHT22 Temperatur und Luftfeuchtigkeit">
...
<div class="container-fluid">
    ...
    <div id="chart" class="collapse in">
        <div class="container">
    	    ...
    	    <script type="text/javascript" src="./js/DHTChart.js"></script>
        </div>
    </div>
    <div class="container">
